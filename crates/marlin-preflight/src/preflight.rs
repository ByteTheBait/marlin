...
use marlin_config::config::Config;
use marlin_core::skill::Skill;
use marlin_tools::{executor, policy};
...
pub fn startup(
    ...
    marlin_dir: &Path,
    work_dir: &str,
    idx: Option<&marlin_index::index::Index>,
) -> Vec<String> {
    ...
    check_toml_file::<marlin_config::config::LayoutConfig>(
    ...
    scan_toml_dir::<marlin_tools::external::ExternalTool>(
        &marlin_tools::external::tools_dir(marlin_dir),
        "tool",
        &mut lines,
    );
    scan_toml_dir::<marlin_commands::commands::UserCommand>(
        &marlin_commands::commands::commands_dir(marlin_dir),
        "command",
        &mut lines,
    );
    scan_toml_dir::<marlin_providers::user_providers::UserProvider>(
        &marlin_providers::user_providers::providers_dir(marlin_dir),
        "provider",
        &mut lines,
    );
